...
\begin{itemize}
    ...
    \begin{itemize}
        \item RF1.1: Permitir o cadastro de veículos, com informações como:
        \begin{itemize}
            \item Placa.
            \item Modelo.
    ...
    \begin{itemize}
        \item RF02.1: Permitir o cadastro de motoristas como: 
        \begin{itemize}
    ...
    \begin{itemize}
        \item RF3.1: Exibir relatórios com métricas como:
        \begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \item RF4.2: Implementar sistema de alertas automáticos para eventos críticos
            \begin{itemize}
            \item data de revisão
            \item troca de óleo ou 
            \item troca de pneus.
        \end{itemize}
    \end{itemize}
\end{itemize}
...
\begin{figure}[!hbtp]
    \centering
    \includegraphics[width=0.9\linewidth,height=0.9\textheight,keepaspectratio]{diagrama_uso_drawio.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.4\linewidth,height=0.9\textheight,keepaspectratio]
    {C4Contexto.png}
    \caption{C4 Contexto}
\end{figure}
\newpage
